...
Resource | Type | Time | About | Watched/Read
:-- | :--: | :--: | :--: | :--:
🌐[Amazing tuto for learning Android Studio (GeeksforGeeks)](https://www.geeksforgeeks.org/android/android-studio-tutorial/) | Web tutorial | - | Examples and code | -
🌐[Another android studio tutorial](https://www.homeandlearn.co.uk/android/android.html) | Web tutorial | - | Tutorial with examples (in Java) | -
🌐[Handling multiple buttons](https://stackoverflow.com/questions/25905086/multiple-buttons-onclicklistener-android) | Stackoverflow | - | - | -
🌐[Handling empty editText fields](https://stackoverflow.com/questions/6290531/how-do-i-check-if-my-edittext-fields-are-empty) | Stackoverflow | - | - | - |


### LITERATURE FOR DIPLOMA PROJECT
