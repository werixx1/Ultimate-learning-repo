...
- 🎬[(YT COURSE) Arduino Course](https://www.youtube.com/watch?v=DPqiIzK97K0)[(YT COURSE) Data Structures - Full Course Using C and C++](https://www.youtube.com/watch?v=B31LgI4Y4DQ&list=PLNkeEJ-A8bAem3jPktBpoWMjRACCEK7t1&index=71)
- 📚[Big-O cheatsheet with visualisation](https://www.bigocheatsheet.com/)
- 🌐[Calculating Boyer Moore Bad Character Table with examples](https://medium.com/@sula.ranawake/calculating-boyer-moore-bad-character-table-with-examples-d855e04d5bd8)
---
### ANDROID STUDIO
